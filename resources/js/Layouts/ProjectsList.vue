      ...
      <div class="flex items-center">
        ...
        <div class="relative">
          <button
            ...
            aria-haspopup="true"
            aria-expanded="false"
            v-click-outside="sortMenuHide"
            @click="sortMenuToggle"
          >
          ...
          <div
            :class="sortMenu ? 'opacity-100 scale-100' : 'opacity-0 scale-95'"
    ...
    <ul class="relative z-0 border-b border-gray-200 divide-y divide-gray-200">
      ...
      >
        <div class="flex items-center justify-between space-x-4">
          ...
          <!-- Repo meta info -->
          <div
            class="flex-col items-end flex-shrink-0 hidden space-y-3 sm:flex"
          >
