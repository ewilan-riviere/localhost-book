...
<body>
    ...
    <nav class="flex-shrink-0 bg-indigo-600">
        ...
        <div class="relative flex items-center justify-between h-16">
            ...
            <!-- Mobile menu button -->
            <button class="inline-flex items-center justify-center p-2 text-indigo-400 bg-indigo-600 rounded-md hover:text-white hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-indigo-600 focus:ring-white" aria-expanded="false">
            ...
            <div class="flex items-center justify-end">
                ...
                <div id="toggle-profile-dropdown-panel">
                    <button class="flex text-sm text-white bg-indigo-700 rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-indigo-700 focus:ring-white" id="user-menu" aria-haspopup="true">
                ...
                -->
                <div id="profile-dropdown-panel" class="absolute right-0 w-48 py-1 mt-2 transition origin-top-right transform scale-95 bg-white rounded-md shadow-lg opacity-0 ring-1 ring-black ring-opacity-5" role="menu" aria-orientation="vertical" aria-labelledby="user-menu">
        ...
        <div class="px-2 pt-2 pb-3">
            ...
            <a href="#" class="block px-3 py-2 mt-1 text-base font-medium text-indigo-200 rounded-md hover:text-indigo-100 hover:bg-indigo-600">Support</a>
        </div>
        <div class="pt-4 pb-3 border-t border-indigo-800">
            <div class="px-2">
            <a href="#" class="block px-3 py-2 text-base font-medium text-indigo-200 rounded-md hover:text-indigo-100 hover:bg-indigo-600">Your Profile</a>
            <a href="#" class="block px-3 py-2 mt-1 text-base font-medium text-indigo-200 rounded-md hover:text-indigo-100 hover:bg-indigo-600">Settings</a>
            <a href="#" class="block px-3 py-2 mt-1 text-base font-medium text-indigo-200 rounded-md hover:text-indigo-100 hover:bg-indigo-600">Sign out</a>
            </div>
        </div>
        </div>
    </nav>
    ...
    <div class="flex-grow w-full mx-auto max-w-7xl xl:px-8 lg:flex">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="space-y-8 sm:space-y-0 sm:flex sm:justify-between sm:items-center xl:block xl:space-y-8">
                    ...
                    <div class="space-y-1">
                        ...
                        <svg class="w-5 h-5 text-gray-400 group-hover:text-gray-500" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
                    ...
                    <button type="button" class="inline-flex items-center justify-center px-4 py-2 mt-3 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:ml-3 xl:ml-0 xl:mt-3 xl:w-full">
                        Invite Team
                    </button>
                    </div>
                </div>
        ...
        <div class="bg-white lg:min-w-0 lg:flex-1">
            ...
            <div class="flex items-center">
                ...
                <div id="sort-menu-menu" class="absolute right-0 z-10 w-56 mt-2 transition origin-top-right scale-95 bg-white rounded-md shadow-lg opacity-0 ring-1 ring-black ring-opacity-5">
                    <div id="sort-menu-menu" class="py-1" role="menu" aria-orientation="vertical" aria-labelledby="sort-menu">
        ...
        <li class="relative py-5 pl-4 pr-6 hover:bg-gray-50 sm:py-6 sm:pl-6 lg:pl-8 xl:pl-6">
                ...
                <div class="min-w-0 space-y-3">
                    ...
                    <span class="block">
                        ...
                        <a href="{{ $repository->vhost_link }}">
                            ...
                            {{ $repository->name }} <span class="sr-only">Running</span>
                        </a>
                        </h2>
                    </span>
                    </div>
                    <a href="{{ $repository->vhost_link }}" class="relative group flex items-center space-x-2.5">
                ...
                <div class="flex-col items-end flex-shrink-0 hidden space-y-3 sm:flex">
                    ...
                    <button class="relative bg-white rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" type="button">
                        ...
                        <!-- Heroicon name: star -->
                        <svg class="w-5 h-5 text-yellow-300 hover:text-yellow-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
        ...
        <div class="pl-6 lg:w-80">
            ...
            <ul class="divide-y divide-gray-200">
                ...
                <div class="flex space-x-3">
                    <img class="w-6 h-6 rounded-full" src="https://images.unsplash.com/photo-1517365830460-955ce3ccd263?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=256&h=256&q=80" alt="">
            ...
            <div class="py-4 text-sm border-t border-gray-200">
                <a href="#" class="font-semibold text-indigo-600 hover:text-indigo-900">View all activity <span aria-hidden="true">&rarr;</span></a>
            </div>
            </div>
        </div>
        </div>
